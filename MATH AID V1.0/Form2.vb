Public Class Form2
    ...
    Private Sub ToolStripMenuItem1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripMenuItem1.Click
        MsgBox("Variables the in the appropriate boxes for the first and second equation in form of ax + by = c and it solves it accordingly for you. Thanks for your cooperation.", MsgBoxStyle.Information, "HELP AND INFO")
    End Sub
